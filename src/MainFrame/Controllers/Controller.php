...
class Controller extends WebController
{
     ...
     * @return \stdClass
     * @throws \App\Modules\MainFrame\Exception
     */
    public function Bundle(RequestCollection $get, RequestCollection $post, mixed $payload)
    {
        ...
        $jsBundle = Bundle::Automate('assets.bundle.js', 'js', [
            ['path' => App::$moduleManager->MainFrame->modulePath . '.Bundle/', ['exts' => ['js', 'html']]],
        ]);
